...
public enum Card {
    ...
    BRUTALITY("Brutality", Material.IRON_SWORD, "+8% melee damage.",
            Attribute.ATTACK_DAMAGE, AttributeModifier.Operation.ADD_SCALAR, 0.08),
    ONSLAUGHT("Onslaught", Material.DIAMOND_SWORD, "+15% melee damage.",
    ...
    BERSERKER("Berserker", Material.BLAZE_POWDER, "+20% damage while below 30% health."),
    ...
    SHARPSHOOTER("Sharpshooter", Material.BOW, "+15% projectile damage."),
    ...
    CRIT("Crit", Material.QUARTZ, "25% chance for melee hits to deal +35%."),
    ...
    SPINE_CUTTER("Spine Cutter", Material.NETHERITE_SWORD, "Backstabs deal +2 damage."),
    ...
    GLASS_CANNON("Glass Cannon", Material.TNT, "+30% melee damage, but take 20% more damage.",
            Attribute.ATTACK_DAMAGE, AttributeModifier.Operation.ADD_SCALAR, 0.30),
    ...
    FIRST_STRIKE("First Strike", Material.WOODEN_SWORD, "+20% melee damage to full-health targets."),
    PREDATOR("Predator", Material.BONE, "+15% melee damage to debuffed targets (poison, slow, wither, burning, frozen)."),
    DUELIST("Duelist", Material.CHAIN, "+10% melee damage while exactly one enemy is near you."),
    AERIAL("Aerial", Material.ELYTRA, "+15% melee damage while you're airborne."),
    WARPATH("Warpath", Material.LEATHER_BOOTS, "+12% melee damage while sprinting."),
    COMBO("Combo", Material.CLOCK, "Consecutive hits on the same target stack +5% damage (up to +25%)."),
    VENDETTA("Vendetta", Material.FERMENTED_SPIDER_EYE, "+25% melee damage for 6s against the last enemy that hit you."),
    NIGHT_STALKER("Night Stalker", Material.SCULK, "+15% melee damage to targets standing in darkness."),
    GIANT_SLAYER("Giant Slayer", Material.ANVIL, "+12% melee damage to enemies with more health than you."),
    SHIELDBREAKER("Shieldbreaker", Material.MACE, "+25% melee damage to targets with absorption hearts."),
    ...
    RAMPAGE("Rampage", Material.WITHER_SKELETON_SKULL, "Kills grant +5% damage for 20s, stacking 3 times."),
